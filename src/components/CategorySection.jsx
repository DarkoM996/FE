...
const CategorySection = () => {
  return (
    <div className="max-w-screen-3xl mx-auto relative w-full h-full px-6 py-4">
      <h2 className="text-4xl md:text-5xl py-12">Category Section</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="relative h-[500px]">
          ...
          <div className="absolute top-0 left-0 w-full h-full flex flex-col gap-4 justify-center items-center bg-black/40 rounded-3xl hover:bg-black/10">
