  ...
  return (
    <div className="max-w-screen-3xl mx-auto w-full min-h-screen relative px-6 py-4">
      <div className="grid grid-cols-1 gap-4 md:gap-6 lg:gap-8">
        <Link className="px-6 py-4 bg-primary_lighterShade-400 border rounded-full text-center w-[120px] ">
          Go Back
        </Link>
        {/* Grid for the image and text containers */}
          ...
          <div className="flex flex-col justify-start items-start gap-8 md:gap-12">
            ...
            <div className="flex flex-col justify-start items-start gap-6">
              <div className="flex flex-col justify-start items-start gap-2">
                ...
                <p className="text-xl leading-normal">{product.description}</p>
